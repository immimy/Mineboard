...
export const PencilISquareIcon = (props: IconProps) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='16'
      height='16'
      fill='currentColor'
      className={cn('bi bi-pencil-square', props?.className)}
      viewBox='0 0 16 16'
    >
...
export const FileExcelFillIcon = (props: IconProps) => {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width='16'
      height='16'
      fill='currentColor'
      className={cn('bi bi-file-excel-fill', props?.className)}
      viewBox='0 0 16 16'
    >
